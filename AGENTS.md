...
Use this order: TRUSTED DevForge module; beta/experimental DevForge module after review; approved internal donor pattern; approved OSS component/pattern; new implementation.
...
## Testing and quality
Run the checks required by the changed module. Do not claim completion without reporting applicable lint/static analysis, type checks, tests, migration validation, security checks, and build results. Generated or AI-written code must satisfy the same gates as human-written code.
