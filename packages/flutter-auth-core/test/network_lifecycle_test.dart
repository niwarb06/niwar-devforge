...
void main() {
  test('IO transport applies one deadline to the full request lifecycle', () async {
  ...
  test('profile network interruption preserves session for resume retry', () async {
  ...
  test('cancellation-style logout failure keeps session for resume retry', () async {
